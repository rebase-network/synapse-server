...
export class CellController {
  ...
  @Get('getUnspentCells')
  async getUnspentCells(@Query() unSpentCellsDTO: UnSpentCellsDTO) {
    const queryPrams = {
      lockHash: unSpentCellsDTO.lockHash,
...
//   }
  ...
  @Get('getUDTsByLockHashAndTypeHashes')
  async getUDTsByLockHashAndTypeHashes(@Query() udtsDTO: UDTsDTO): Promise<any> {
    const lockHash = udtsDTO.lockHash;
